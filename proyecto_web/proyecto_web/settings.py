...
STATIC_URL = ["C:/project/proyecto_web/proyectowebapp/static/proyectowebapp/"]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:/project/proyecto_web/proyectowebapp/templates/proyectowebapp', 'C:/project/proyecto_web/tienda/templates/tienda'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/media/'
MEDIA_ROOT = 'C:/project/proyecto_web/proyecto_web/media'
